...
const getUserStats = async () => {
  ...
  try {
    ...
    const newUsersThisMonth = await $app
      .db()
      .newQuery(
        `
...
const cleanupOldData = async () => {
  ...
  try {
    // Delete old sessions
    const deletedSessions = await $app
      .db()
      .newQuery(
        `
