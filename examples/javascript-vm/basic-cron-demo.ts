...
`));
    ...
    console.log(chalk.gray('  1. Copy the code to a file in your pb_jobs/ directory'));
    ...
    console.log(chalk.gray('You can copy this file directly to your PocketBase instance.'));

    DemoUtils.printSection('Customization Ideas');
    console.log(chalk.gray('You can customize this basic job by:'));
    console.log(chalk.gray('  • Changing the schedule (e.g., every 30 seconds)'));
